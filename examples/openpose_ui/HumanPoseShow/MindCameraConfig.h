#ifndef MIND_CAMERA_CONFIG_H
#define MIND_CAMERA_CONFIG_H
...
namespace Ui {
class MindCameraConfig;
}

class MindCameraConfig : public QDialog {
    Q_OBJECT
public:
    MindCameraConfig(QWidget *parent = 0);
    ~MindCameraConfig();
